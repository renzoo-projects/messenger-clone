...
export default function PusherConnectionIndicator() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 flex items-center justify-center gap-2 bg-amber-500 px-4 py-1 text-xs text-white motion-safe:animate-slideDown">
